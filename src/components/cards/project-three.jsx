  ...
  return (
    <div className="project-card" id="project-three">
      ...
      <p className="project-desc">
        A really cool project. I promise once I get back in my groove with this
        portfolio warm up the projects will come. I have a ton of projects in
        the works including a <span>Harry Potter Quiz</span> and{" "}
